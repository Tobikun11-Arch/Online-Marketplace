    ...
    return (
        <div>
            ...
            <div className='flex flex-col gap-5 sm:flex-row sm:gap-2 mt-4'>
                <div className="w-full h-40 bg-white border-2 border-[#3333] rounded-lg p-4 space-y-2 relative">
                ...
                <div className="w-full h-40 bg-gray-800 rounded-lg p-4 space-y-2 relative">
                    <div className="flex justify-between items-center space-x-4">
                        <div className="flex space-x-1">
                            <div className="w-8 h-2 bg-gray-700 rounded"></div>
                            <div className="w-8 h-2 bg-gray-700 rounded"></div>
