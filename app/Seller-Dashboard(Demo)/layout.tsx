    ...
    return (
        <div className='h-screen text-black bg-[#FAFAFA] dark:bg-[#FAFAFA] cursor-default'>
            <div className='flex h-full flex-1 overflow-hidden'>
                <div className='lg:w-80 lg:h-full fixed top-[140px] lg:top-0 lg:relative hidden sm:flex flex flex-col justify-center lg:justify-start bg-[#FAFAFA] lg:bg-[#1B2130] text-gray-300 z-10'>
                    <Sidebar />
                </div>
