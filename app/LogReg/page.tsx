...
export default function Page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        const response = await fetch(`https://nodejs-serverless-function-express-lake-ten.vercel.app/api/users/register`, { 
  ...
  const handleLogin = async (e: React.FormEvent) => {
    e.preventDefault(); //user details to server post in server.ts to insert in database
    try {
      const response = await fetch(`https://nodejs-serverless-function-express-lake-ten.vercel.app/api/users/login`, {
          method: 'POST',
          headers: {
