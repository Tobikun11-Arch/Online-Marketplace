...
//My default fetch
export const PostFetch = async(url: string, PostType: AxiosInstance, data: PostData): Promise<ResponseData | void> => {
    try {
        const response: AxiosResponse<ResponseData> = await PostType.post(url, data);
