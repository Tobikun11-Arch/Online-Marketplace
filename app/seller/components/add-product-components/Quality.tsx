...
export default function QualityComponents() {
    ...
    return (
        ...
        <Field>
            ...
            >
                <option value="New" onClick={()=> setQuality('New')}>New</option>
                <option value="Refurbished" onClick={()=> setQuality('Refurbished')}>Refurbished</option>
                <option value="Used" onClick={()=> setQuality('Used')}>Used</option>
            </Select>
            <ChevronDownIcon
